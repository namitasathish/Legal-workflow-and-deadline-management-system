                    ...
                    <View style={styles.logItem}>
                        ...
                        <View style={styles.logContent}>
                            ...
                            <View style={styles.logMeta}>
                                <View style={[styles.actionBadge, { backgroundColor: (ac[item.action] || colors.textSecondary) + '20' }]}>
                                    <Text style={[styles.actionText, { color: ac[item.action] || colors.textSecondary }]}>{item.action}</Text>
                                </View>
